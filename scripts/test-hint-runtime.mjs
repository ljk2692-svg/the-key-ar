...
const activeIds=["H-R1Q01","H-R1Q03","H-R1Q05","H-R1Q06","H-R2M02","H-R3GUIDE","H-R3M01","H-R3M02","H-R3M03","H-R3M04","H-R3M05","H-R3M06","H-R3M07","H-R3M08"];
const pendingIds=[];
...
const objectBudgets={};
const sourceRailClasses={"H-R1Q03":"mapping","H-R1Q05":"twoStage","H-R1Q06":"tripleDecode","H-R3M02":"fragmentFilter","H-R3M03":"gestureVerify","H-R3M04":"rotateClue"};
for(const id of activeIds){
  ...
  if(sourceRailClasses[id])assert.match(elements.hintSpatialContent.innerHTML,new RegExp(`hintVisualRail ${sourceRailClasses[id]}`),`${id} renders its source-specific readable rail`);
...
console.log("PASS  all mission sources resolved · 14/14");
